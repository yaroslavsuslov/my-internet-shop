...
import com.suslov.persist.repo.RoleRepository;
import com.suslov.service.UserService;
...
public class UserController {
    ...
    public String adminEditUser(Model model, @PathVariable("id") Long id) {
        ...
        model.addAttribute("activePage", "Users");
        model.addAttribute("user", userService.findById(id).orElseThrow(IllegalStateException::new));
    ...
    @PostMapping("/user")
    public String adminInsertUser(@Valid UserRepr user, Model model, BindingResult bindingResult) {
        model.addAttribute("activePage", "Users");
